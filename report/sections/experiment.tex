...
\begin{figure}[!htbp]
    ...
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_r0.png}
    }
    \subfigure[$ r_2(x, y)=1+\cos (1 / (x+0.001) )$]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_r1.png}
    }
    \subfigure[$ r_3(x, y)=\frac{1}{2}-\left|y-\frac{1}{2}\right|$]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_r2.png}
    }
    \subfigure[$ r_4(x, y)=(1+\exp (x y))^{-1}$]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_r3.png}
    }
    \subfigure[$ r_5(x, y)=1+\arcsin (-1+2 \sqrt{x y})$]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_r4.png}
    }
...
\begin{figure}[!htbp]
    ...
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_n5.png}
    }
    \subfigure[$ r_2(x, y)$ with n=7]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_n7.png}
    }
    \subfigure[$ r_2(x, y)$ with n=9]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_n9.png}
    }
    \subfigure[$ r_2(x, y)$ with n=13]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_n13.png}
    }
    \subfigure[$ r_2(x, y)$ with n=15]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_n15.png}
    }
    \subfigure[$ r_2(x, y)$ with n=18]
    {
    \centering
    \includegraphics[width=0.3\columnwidth]{images/min_surf_n18.png}
    }
